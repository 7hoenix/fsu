...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { instructordescription: @instructor.instructordescription, instructorname: @instructor.instructorname, qualifications: @instructor.qualifications }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { instructordescription: @instructor.instructordescription, instructorname: @instructor.instructorname, qualifications: @instructor.qualifications }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
